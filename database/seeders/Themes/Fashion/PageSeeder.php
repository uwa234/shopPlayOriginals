        ...
        return [
            [
                ...
                'content' => '[simple-slider style="2" key="home-slider" shape_1="fashion/sliders/shape-1.png" shape_2="fashion/sliders/shape-2.png" shape_3="fashion/sliders/shape-3.png" is_autoplay="yes" autoplay_speed="5000"][/simple-slider]' .
                    ...
                    '[ecommerce-categories style="slider" title="Popular on the Shofy store." subtitle="Shop by Category" category_ids="1,2,7,11,18,19" enable_lazy_loading="no"][/ecommerce-categories]' .
                    ...
                    '[ecommerce-products style="slider-full-width" title="This Week\'s Featured" subtitle="Shop by Category" collection_ids="1" limit="5" with_sidebar="1" background_color="#EFF1F5" enable_lazy_loading="yes"][/ecommerce-products]' .
                    '[ecommerce-products title="Trending Arrivals" subtitle="More to Discover" collection_ids="1" limit="5" with_sidebar="1" ads_ids="6" style="slider" ads="VKJNCBIBQC1O" enable_lazy_loading="yes"][/ecommerce-products]' .
