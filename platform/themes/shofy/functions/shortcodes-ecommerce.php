...
use Botble\Ecommerce\Models\PreOrder;use Botble\Ecommerce\Models\Product;
...
app()->booted(function (): void {
    ...
    Shortcode::setPreviewImage('ecommerce-pre-order', Theme::asset()->url('images/shortcodes/ecommerce-pre-order/style-1.png'));
    ...
    Shortcode::setAdminConfig('ecommerce-pre-order', function (array $attributes) {
        ...
        foreach (range(1, 2) as $i) {
            $styles[$i] = [
                'label' => __('Style :number', ['number' => $i]),
                'image' => Theme::asset()->url("images/shortcodes/ecommerce-pre-order/style-$i.png"),
            ];
        }
