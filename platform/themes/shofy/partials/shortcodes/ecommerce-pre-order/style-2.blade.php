                ...
                <div class="tp-deal-content text-center">
                    ...
                    @if($preOrder)
                        <div class="tp-deal-countdown">
                            @include(Theme::getThemeNamespace('views.ecommerce.includes.product.countdown'), ['endDate' => $preOrder->expected_delivery_date])
                        </div>
                        <div class="text-center mt-3">
                            <p class="text-muted">{{ __('Expected Delivery Date') }}</p>
                        </div>
                    @endif
                </div>
            </div>
