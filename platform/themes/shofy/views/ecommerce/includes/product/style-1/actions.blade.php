<div class="tp-product-action">
    <div class="d-flex flex-column tp-product-action-item">
        @if (EcommerceHelper::isCompareEnabled())
            <button
                type="button"
                @class(['tp-product-compare-btn tp-product-action-btn', 'active' => $isInCompare = is_product_in_compare($product->original_product->id)])
        ...
        @if (EcommerceHelper::isWishlistEnabled())
            <button
                type="button"
                @class(['tp-product-add-to-wishlist-btn tp-product-action-btn', 'active' => $isInWishlist = is_product_in_wishlist($product->original_product->id)])
