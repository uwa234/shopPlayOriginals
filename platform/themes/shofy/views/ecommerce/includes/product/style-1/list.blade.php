<div class="tp-product-list-item d-md-flex">
    ...
    <div class="tp-product-list-content">
        <div class="tp-product-content-2 pt-15">
            ...
            <div @class(['my-2 tp-product-price-review' => theme_option('product_listing_review_style', 'default') !== 'default' && EcommerceHelper::isReviewEnabled() && ($product->reviews_avg || theme_option('ecommerce_hide_rating_star_when_is_zero', 'no') === 'no')])>
